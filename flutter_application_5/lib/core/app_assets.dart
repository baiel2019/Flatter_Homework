...
class AppAssetsList{
 static List<String> listImagesColumn = [
  ...
  'assets/images/naruto_c1.png',
  'assets/images/naruto_c2.png',
  'assets/images/naruto_c3.png',
  
  'assets/images/naruto.png',
  
  
  'assets/images/pistolet.png',
  'assets/images/png-transparent-free-download-icon-cloud-down-computer-system-blue-computer-blue-laptop.png',
